...
function M.setup(opts)
  ...
  vim.api.nvim_set_keymap("n", "<Leader>rp", ":lua require('fzf-lua').grep()<CR>", { noremap = true, silent = true })
  vim.api.nvim_set_keymap("v", "<Leader>rv", ":lua require('fzf-lua').grep_visual()<CR>", { noremap = true, silent = true })
